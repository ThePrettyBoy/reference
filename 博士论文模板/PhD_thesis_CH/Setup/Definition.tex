...
\newcommand{\xiaoyi}{\fontsize{24pt}{24pt}\selectfont}       % 一号, 1.倍行距
...
\newtheorem{corollary}{\hei 推论~}[section]
\newtheorem{remark}{\hei 注~}[section]
\newtheorem{problem}{\hei 问题~}[section]
\newtheorem{example}{\hei 例~}[section]
%\newtheorem{algorithm}{\hei 算法~}[section]
...
\titleformat{\section}[hang]{\hei\bf\filcenter\xiaosan}{\xiaosan{\S~\thesection}}{0.5em}{}
\titlespacing{\section}{0pt}{13pt}{13pt}


\titleformat{\subsection}[hang]{\hei\bf\filcenter\sihao}{\sihao\S~\thesubsection}{0.5em}{}
\titlespacing{\subsection}{0pt}{8pt}{7pt}

%\titleformat{\subsubsection}[runin]{\hei\bf\filcenter\xiaosi}{\thesubsubsection}{0.5em}{}[\;\;]

\titleformat{\subsubsection}[hang]{\hei\bf\filcenter\xiaosi}{\S~\thesubsubsection}{0.5em}{}
\titlespacing{\subsubsection}{0pt}{3pt}{2pt}

% 缩小目录中各级标题之间的缩进，使它们相隔一个字符距离，也就是12pt
\makeatletter
\renewcommand*\l@chapter{\@dottedtocline{1}{0em}{1.1em}}
\renewcommand*\l@section{\@dottedtocline{1}{18pt}{18pt}}
\renewcommand*\l@subsection{\@dottedtocline{2}{30pt}{30pt}}
...
\makeatother
\dottedcontents{chapter}[1.1em]{\hspace{-1.1em}\hei\bf \vspace{0.2em}}{0.0em}{5pt}
\dottedcontents{section}[1.3cm]{\vspace{0em}}{1.8em}{5pt}
\dottedcontents{subsection}[2.2cm]{}{2.7em}{5pt}
...
%%%%%%%%%=========== 定义公式与文本行距 ===============
%\everydisplay{
%\abovedisplayskip=.55\baselineskip  plus.3ex minus.3ex
%\abovedisplayshortskip=-0.15\baselineskip plus.3ex minus.3ex
%\belowdisplayskip=.55\baselineskip plus.3ex minus.3ex
%\belowdisplayshortskip=.55\baselineskip plus.3ex minus.3ex
%}

%\setlength{\abovedisplayshortskip}{0.22cm}
%\setlength{\belowdisplayshortskip}{0.22cm}
%\setlength{\abovedisplayskip}{0.22cm}
%\setlength{\belowdisplayskip}{0.22cm}

%%%%%%%%%%========================================

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Definition of mathematical operator %%%%%%%%%%
\def\be{\beta}
\def\ba{\bar}
\def\de{\delta}
%\def\S{{\cal S}}
...
\definecolor{shadecolor}{rgb}{0.95,0.95,0.95}  %% 用于设置文本背景颜色
%% \begin{shaded}
%%  text
%%\end{shaded} 